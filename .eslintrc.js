module.exports = {
    ...
    rules: {
        ...
        '@typescript-eslint/no-parameter-properties': [
            'error',
            { allows: ['public', 'private', 'protected', 'readonly', 'private readonly', 'protected readonly', 'public readonly'] }
        ],
        ...
        'react/jsx-max-props-per-line': [1, { maximum: 6 }], // 限制JSX中单行上的props的最大数量
